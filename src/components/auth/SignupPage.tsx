...
import { Terminal, ShieldCheck, Mail, Lock, User, UserPlus } from "lucide-react"
    ...
    <div className="min-h-screen bg-canvas flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-xs text-text-muted">
          Register to set up cron scheduled endpoints
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-surface py-8 px-6 border border-border rounded-xl shadow-sm sm:px-10">
          ...
          {successMsg && (
            <div className="mb-4 rounded-lg bg-success-bg border border-success/15 p-3 text-xs font-bold text-success flex items-center gap-2 animate-fade-in">
          ...
          <div className="mt-6">
            ...
            <div className="mt-4">
              <button
                onClick={() => window.location.href = authService.getGoogleOAuthUrl()}
